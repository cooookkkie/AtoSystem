...
namespace AdoNetWindow.MiniGame.AvoidStar
{
    public partial class AvoidStar : Form
    {
        ...
        private void pictureBox1_Paint(object sender, PaintEventArgs e)
        {
            ...
            else if (gameState == 3)
            {
                ...
                Image gameover = Properties.Resources.gameover; // 이미지로 가져오는 소스
            ...
            else if (gameState == 1)
            {
                ...
                Image ship = Properties.Resources.ship; // 이미지로 가져오는 소스
        ...
        private void AvoidStar_KeyUp(object sender, KeyEventArgs e)
        {
            //키코드를 뗄 때 입력받는 함수
        ...
        private void AvoidStar_KeyDown(object sender, KeyEventArgs e)
        {
            // 키코드를 누를 때 입력 받는 함수
            ...
            if (gameState == 1)
            {
                ...
                for (int i = 0; i < missile_quantity; i++)
                {
                    if (rt.Contains(ballPoint[i].X, ballPoint[i].Y) == true)
                    {
                        ...
                        textBox1.Text = Watch.sec + ":" + Watch.milisec + "초";
                        timer3.Stop();
                        MessageBox.Show(this,"기록 : " + Watch.sec + ":" + Watch.milisec + "초");
                        break;
