...
namespace Repositories
{
    public interface IProductOtherCostRepository
    {
        ...
        DataTable GetProduct(string product, string origin, string sizes, string unit, string manager = "", string group = "");
        ...
        StringBuilder UpdateOffer(string product_origin, string origin_origin, string sizes_origin, string unit_origin, string product, string origin, string sizes, string unit);
        StringBuilder UpdatePendding(string product_origin, string origin_origin, string sizes_origin, string unit_origin, string product, string origin, string sizes, string unit);
    }
}
